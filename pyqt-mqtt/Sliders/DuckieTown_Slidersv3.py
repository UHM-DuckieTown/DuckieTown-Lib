...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Duck_Check = QtWidgets.QCheckBox(self.centralwidget)
        self.Duck_Check.setGeometry(QtCore.QRect(910, 820, 70, 17))
        self.Duck_Check.setObjectName("Duck_Check")
        ...
        self.Duck2_Slider_2 = QtWidgets.QSlider(self.centralwidget)
        self.Duck2_Slider_2.setGeometry(QtCore.QRect(940, 50, 22, 311))
        self.Duck2_Slider_2.setMaximum(4)
        self.Duck2_Slider_2.setSingleStep(1)
        self.Duck2_Slider_2.setPageStep(1)
        self.Duck2_Slider_2.setOrientation(QtCore.Qt.Vertical)
        self.Duck2_Slider_2.setTickPosition(QtWidgets.QSlider.TicksBelow)
        self.Duck2_Slider_2.setTickInterval(1)
        self.Duck2_Slider_2.setObjectName("Duck2_Slider_2")
        self.Duck2_Slider_3 = QtWidgets.QSlider(self.centralwidget)
        self.Duck2_Slider_3.setGeometry(QtCore.QRect(940, 410, 22, 311))
        self.Duck2_Slider_3.setMaximum(4)
        self.Duck2_Slider_3.setSingleStep(1)
        self.Duck2_Slider_3.setPageStep(1)
        self.Duck2_Slider_3.setOrientation(QtCore.Qt.Vertical)
        self.Duck2_Slider_3.setTickPosition(QtWidgets.QSlider.TicksBelow)
        self.Duck2_Slider_3.setTickInterval(1)
        self.Duck2_Slider_3.setObjectName("Duck2_Slider_3")
        ...
        self.Directions1 = QtWidgets.QLabel(self.centralwidget)
        self.Directions1.setGeometry(QtCore.QRect(1060, 10, 91, 20))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.Directions1.setFont(font)
        self.Directions1.setObjectName("Directions1")
        self.Directions_List1 = QtWidgets.QListView(self.centralwidget)
        self.Directions_List1.setGeometry(QtCore.QRect(1050, 50, 111, 311))
        self.Directions_List1.setObjectName("Directions_List1")
        self.Directions_List2 = QtWidgets.QListView(self.centralwidget)
        self.Directions_List2.setGeometry(QtCore.QRect(1050, 410, 111, 311))
        self.Directions_List2.setObjectName("Directions_List2")
        self.Directions2 = QtWidgets.QLabel(self.centralwidget)
        self.Directions2.setGeometry(QtCore.QRect(1060, 370, 91, 20))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.Directions2.setFont(font)
        self.Directions2.setObjectName("Directions2")
        self.Clear_Directions1 = QtWidgets.QPushButton(self.centralwidget)
        self.Clear_Directions1.setGeometry(QtCore.QRect(1150, 10, 41, 21))
        self.Clear_Directions1.setObjectName("Clear_Directions1")
        self.Clear_Directions2 = QtWidgets.QPushButton(self.centralwidget)
        self.Clear_Directions2.setGeometry(QtCore.QRect(1150, 370, 41, 21))
        self.Clear_Directions2.setObjectName("Clear_Directions2")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Duck_Check.setText(_translate("MainWindow", "Duck 2"))
        ...
        self.Directions1.setText(_translate("MainWindow", "Directions"))
        self.Directions2.setText(_translate("MainWindow", "Directions"))
        self.Clear_Directions1.setText(_translate("MainWindow", "Clear"))
        self.Clear_Directions2.setText(_translate("MainWindow", "Clear"))
